...
function varExample() {
    ...
    console.log("Value of x outside the block using var:", x); // 20 (var has function
    //  or global scope)
}
varExample();
...
function letExample() {
    ...
    if (true) {
        let y = 20; // Block scope; doesn't affect outer variable
        console.log("Value of y inside block using let:", y); // 20
    }
